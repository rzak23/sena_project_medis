...
if (isset($_POST["btn_simpan_pasien"])) {
  if (tambah_pasien($_POST) > 0) {
    echo "<script>alert ('Penambahan data pasien berhasil!'); document.location.href = 'rekam-medis.php';</script>";
  } else {
    echo "<script>alert ('Penambahan data pasien gagal!'); document.location.href = 'rekam-medis.php';</script>";
  }
}
?>
<!-- Modal Tambah Pasien -->
