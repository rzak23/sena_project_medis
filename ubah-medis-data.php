...
if (isset($_POST["btn_ubah_medis"])) {
  if (ubah_medis($_POST) > 0) {
    echo "<script>alert ('Perubahan data rekam medis berhasil!'); document.location.href = 'rekam-medis-data.php'</script>";
  } else {
    echo "<script>alert ('Perubahan data rekam medis gagal!'); document.location.href = 'rekam-medis-data.php'</script>";
  }
}
?>
